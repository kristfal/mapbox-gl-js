    ...
    for (var k = 0; k < matching.length; k++) {
        ...
        for (var l = 0; l < layerIDs.length; l++) {
            ...
            if (styleLayer.type === 'symbol') {
                ...
                translatedPoint = p.sub(Point.convert(styleLayer.paint['line-translate'])._mult(pixelsToTileUnits));
                ...
                translatedPoint = p.sub(Point.convert(styleLayer.paint['fill-translate'])._mult(pixelsToTileUnits));
                if (radiusSearch ?
                ...
                translatedPoint = p.sub(Point.convert(styleLayer.paint['circle-translate'])._mult(pixelsToTileUnits));
